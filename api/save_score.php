...
// Endpoint de insercion de puntaje.
// Recibe JSON del frontend al finalizar una partida.
...
// Reglas minimas de validacion para proteger integridad de datos.
...
try {
    ...
    app_log('/api/save_score.php', 'db_error', ['error' => $e->getMessage()]);
    json_response(['ok' => false, 'message' => 'Error de base de datos al guardar puntaje.'], 500);
}
